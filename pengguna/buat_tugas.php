...
// Kode Php
include '../php/pengguna/buat_tugas.php';
...
<head>
    ...
    <!-- Title -->
    <title>Listify - Buat Tugas</title>
...
>>>>>>> 61c90a0 (Perubahan Pada Kalender Dan Cookie)
        ...
        <div class="flex-1 flex flex-col bg-gray-50 p-4 overflow-y-auto">
            ...
            <!-- Title -->
            <h2 class="text-2xl font-semibold mb-6 text-gray-700">Buat Tugas</h2>

            <!-- Content -->
            <div class="bg-white p-6 rounded-lg shadow-md">
                <h3 class="text-lg font-semibold text-gray-700 mb-4">Buat Tugas Baru</h3>
